  ...
  return (
    <Fragment>
      ...
      <InfoboxModal
        ...
        title="Условия за АртКомпас"
        description={
          <>
            <h3>Последна актуализация: 19/04/2025</h3>
            <p>
              АртКомпас е лицензиран на Вас (Краен потребител) за ползване само
              в съответствие с условията на това Споразумение за лиценз.
            </p>
            <p>
              Чрез достъпа до уеб приложението АртКомпас, Вие потвърждавате, че
            ...
            <p>
              Лицензодателят е единствено отговорен за уеб приложението
              АртКомпас и съдържанието му.
            </p>
            <p>
              АртКомпас е уеб приложение, което позволява на потребителите да
            ...
            <ul>
              <li>
                ...
                несублицензируем лиценз да използвате уеб приложението АртКомпас
            ...
            <ul>
              <li>
                2.1 АртКомпас събира и съхранява лични данни, като име, имейл
              ...
              <li>
                2.3 АртКомпас предприема подходящи технически и организационни
            ...
            <ul>
              ...
              <li>
                5.3 Продължаващото използване на уеб приложението АртКомпас след
