...
const RecommendationCard: FC<RecommendationCardProps> = ({
  ...
  if (isVRSupported && enterVR) {
    return (
      <Canvas>
        <XR store={store}>
          <ambientLight />
          <directionalLight position={[0, 2, 2]} />
          <Html position={[0, 1.6, -2]} transform>
            <div className="scale-[1.2] max-w-5xl w-full">
                ...
                <div className="flex w-full items-center sm:items-start flex-col md:flex-row">
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="top-0 z-10">
                      <a
                        href="#"
                        className="block text-xl sm:text-3xl font-bold mb-1"
                      >
                      ...
                      <p className="flex gap-1 recommendation-small-details text-sm italic text-defaulttextcolor/70">
                        ...
                        | {recommendation.year || "Година неизвестна"} |
                        Рейтинг: {recommendation.rated || "N/A"}
                      </p>
                      {/* Рейтинги */}
