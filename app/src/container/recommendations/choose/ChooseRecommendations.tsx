...
const ChooseRecommendations: FC = () => {
  ...
  const question = {
    question:
      "Искате да четете или гледате нещо, но не знаете какво? Арт Компас ще направи избора Ви лесен като Ви зададе няколко въпроса за Вашите предочитания и Ви предложи най-добре отговарящите на тях филми, сериали и книги!", // Самият въпрос
    options: [
