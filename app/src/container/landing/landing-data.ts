...
export const averagesInfo = {
  "Среден Боксофис":
    "Боксофисът е общата сума на приходите от продажба на билети в киносалоните. Измерва се в милиони или милиарди долари и е ключов показател за търговския успех на филма.",
  "Среден IMDb Рейтинг":
  ...
  "Среден Rotten Tomatoes Рейтинг":
    "Rotten Tomatoes е платформа, показваща процента на положителните рецензии от критици (Tomatometer) - това е процентът, който виждате като рейтинг, или от зрители (Audience Score). Средният рейтинг е различна метрика – той представлява средната оценка (от 0 до 10) на всички рецензии, което дава представа не само за това колко хора са харесали даден филм, но и колко силно са го харесали."
};
...
export const awardsInfo = {
  ...
  "Общ брой спечелени Оскари":
    "Общият брой на спечелените награди Оскар на филмите и сериалите в платформата.",
  "Общ брой номинации за Оскари":
    "Общият брой на номинациите за награди Оскар на филмите и сериалите в платформата."
};
